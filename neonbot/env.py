...
CONTEXT_MENU_GUILD_ID = env.int('CONTEXT_MENU_GUILD_ID', default=1008661677446807713)
CONTEXT_MENU_GUEST_ROLE_ID = env.int('CONTEXT_MENU_GUEST_ROLE_ID', default=1016294997353570305)
CONTEXT_MENU_MEMBER_ROLE_ID = env.int('CONTEXT_MENU_MEMBER_ROLE_ID', default=1008661677446807714)
